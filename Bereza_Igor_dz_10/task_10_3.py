class Cell:
    ...
    def __str__(self):
        return str(self.amount_nucleus)

    def __add__(self, other_cell):
        return Cell(self.amount_nucleus + other_cell.amount_nucleus)
...
cell_1 = Cell(12)
cell_2 = Cell(15)
print(f'Кол-во ячеек первой клетки: {cell_1}')
print(f'Кол-во ячеек второй клетки: {cell_2}')
print('-------')
